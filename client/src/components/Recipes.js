    ...
    return (
        <div className='w-full'>
...

            {
                recipes?.length > 0 ? (
                    <>
                        <h2 className='px-2 py-1 text-[50px] capitalize shadow-xl rounded-full mr-3 text-orange-400'>Featured recipes</h2>
                        <div className='w-full  flex flex-wrap gap-10 px-0 lg:px-100 py-10'>
                            {
                        ...
                        <div className='flex w-full items-center justify-center py-10'>
                            <Link to='/signup' className='bg-green-800 text-white px-3 py-1 rounded-full text-sm'>
                                Show More
                            </Link>
                           {/*  <Button
                                title="Show More"
